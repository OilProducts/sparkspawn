    ...
    return (
        <div data-testid={testId} className="space-y-1.5 rounded-md border border-border/80 bg-muted/10 px-3 py-3">
            ...
            <textarea
                ...
                rows={4}
                className="min-h-24 w-full rounded-md border border-input bg-background px-2 py-2 font-mono text-xs shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
